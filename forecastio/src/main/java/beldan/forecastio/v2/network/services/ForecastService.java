...
package beldan.forecastio.v2.network.services;
...
import beldan.forecastio.network.Network;
import beldan.forecastio.network.requests.NetworkRequest;
import beldan.forecastio.network.responses.INetworkResponse;
import beldan.forecastio.network.responses.NetworkResponse;
import beldan.forecastio.utilities.NetworkUtils;
import beldan.forecastio.v2.network.responses.ForecastResponse;
import beldan.forecastio.v2.transfer.DataBlock;
import beldan.forecastio.v2.transfer.DataPoint;
import beldan.forecastio.v2.transfer.LatLng;
