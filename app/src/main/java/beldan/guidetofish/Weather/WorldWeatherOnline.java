...
public class WorldWeatherOnline extends WeatherProvider {
    ...
    static final String API_KEY = "0d2f58949bd027f754c6b289caec0";

    @Override
    public Forecast requestWeatherForecast(double lat, double lon,
                                           int numOfDays) {
        String URL = "http://api2.worldweatheronline.com/free/v1/weather.ashx&q=" + lat + "," + lon + "&format=json&num_of_days=" + numOfDays + "&key=" + API_KEY;
    ...
    public Forecast requestWeatherForecast(String city, int numOfDays) {
        String URL = "http://api2.worldweatheronline.com/free/v1/weather.ashx&q=" + city + "&format=json&num_of_days=" + numOfDays + "&key=" + API_KEY;
