...
/**
 * Created by danielhart on 20/03/15.
 */
public class CaughtFishDatabaseHandler extends SQLiteOpenHelper {
    // All Static variables
    // Database Version
    private static final int DATABASE_VERSION = 3;

    // Database Name
    private static final String DATABASE_NAME = "CaughtFish";
    ...
    public CaughtFishDatabaseHandler(Context context) {
